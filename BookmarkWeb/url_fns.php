<?php
	...
	//pre-condition:get all the bookmarks that user has placed in the database, receiving only the username
	//post-condition: Function will return false if the query could not be accomplied. Otherwise an array of URL's only will be inserted into 'url_array'
